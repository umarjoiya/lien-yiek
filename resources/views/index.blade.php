    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="./Dashboard">
                    <!-- <img style="margin-left: 40px; margin-top: -6px;width: 150px; height: 90px;" src="{{url('assets/images/lien_orig.png')}}" alt=""> -->
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Machine</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./machine-database-list">Machine List</a></li>
                        </ul>
                    </li>
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Operater</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./operater-list">Operater List</a></li>
                        </ul>
                    </li>
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Material</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./material-InOut">Material In Out</a></li>
                        </ul>
                    </li>
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Batch</span>
                        </a>
                        <ul aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-envelope menu-icon"></i> <span class="nav-text">Production Order</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./production-order-list">Production Order List</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-graph menu-icon"></i> <span class="nav-text">Quality Control</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./grind">Grinding</a></li>
                        </ul>
                        <ul aria-expanded="false">
                            <li><a href="./drilling">Drilling</a></li>
                        </ul>
                        <ul aria-expanded="false">
                            <li><a href="./finalchecking">Final Checking</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-screen-tablet menu-icon"></i><span class="nav-text">Warehouse Out</span>
                        </a>
                        <ul aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-grid menu-icon"></i><span class="nav-text">Shotblast</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./shotblast">Shotblast</a></li>                      
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-layers menu-icon"></i><span class="nav-text">Location</span>
                        </a>
                        <ul aria-expanded="false">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; 2022<a href="https://iotsata.com/">  IOT SATA SDN BHD </a>. All right reserved.</p>
            </div>
        </div>
        <!--**********************************
            Footer end
